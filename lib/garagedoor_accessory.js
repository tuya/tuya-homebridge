...
class GarageDoorAccessory extends BaseAccessory {
  constructor(platform, homebridgeAccessory, deviceConfig) {
    ...
    // console.log("GarageDoorAccessory statusArr.", this.statusArr);
    ...
    this.service.getCharacteristic(name)
      .on('get', callback => {
        if (this.hasValidCache()) {
          // console.log("GarageDoorAccessory getCharacteristic get.", this.getCachedState(name));
          callback(null, this.getCachedState(name));
        }
      })
      .on('set', (value, callback) => {
        var param = this.getSendParam(name, value)
        // console.log("GarageDoorAccessory getCharacteristic set name.", name);
  ...
  updateState(data) {
    ...
    // console.log("GarageDoorAccessory updateState devices", data);
  }
}
