...
class TuyaOpenAPI {
  ...
  async getDeviceList() {
    ...
    // console.log(`TuyaOpenAPI devicesInfoArr: `, devicesInfoArr);
    // console.log(`TuyaOpenAPI devicesStatusArr: `, devicesStatusArr);
  ...
  async getDeviceInfo(deviceID) {
    ...
    // console.log(`TuyaOpenAPI HY getDeviceInfo`);
    return res.result;
  }
