    ...
    for (var statusMap of this.statusArr) {
      switch (statusMap.code) {
        case 'bright_value':
          ...
          } else if (this.deviceCategorie == 'fsd' || this.deviceCategorie == 'xdd' || this.deviceCategorie == 'fwd' || this.deviceCategorie == 'tgq' || this.deviceCategorie == 'dd' || this.deviceCategorie == 'tgkg') {
        ...
        case 'temp_value':
          ...
          } else if (this.deviceCategorie == 'fsd' || this.deviceCategorie == 'xdd' || this.deviceCategorie == 'fwd' || this.deviceCategorie == 'dd') {
