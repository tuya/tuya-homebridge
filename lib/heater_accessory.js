...
class HeaterAccessory extends BaseAccessory {
  constructor(platform, homebridgeAccessory, deviceConfig) {
    ...
    // console.log("HeaterAccessory statusArr.", this.statusArr);
    ...
    this.service.getCharacteristic(name)
      .on('get', callback => {
        if (this.hasValidCache()) {
          // console.log("HeaterAccessory getCharacteristic get.", this.getCachedState(name));
          callback(null, this.getCachedState(name));
        }
      })
      .on('set', (value, callback) => {
        var param = this.getSendParam(name, value)
        // console.log("HeaterAccessory getCharacteristic set name.", name);
  ...
  updateState(data) {
    ...
    // console.log("HeaterAccessory updateState devices", data);
  }
}
